package com.signalfx.signalflow.client.connection;

import com.signalfx.signalflow.client.endpoint.SignalFxReceiverEndpoint;
...
public abstract class AbstractHttpReceiverConnection {
    ...
    protected AbstractHttpReceiverConnection(SignalFxReceiverEndpoint endpoint, int timeoutMs,
        ...
        this(endpoint, timeoutMs, RetryDefaults.DEFAULT_MAX_RETRIES, httpClientConnectionManager);
    }

    protected AbstractHttpReceiverConnection(SignalFxReceiverEndpoint endpoint, int timeoutMs, int maxRetries,
                                             HttpClientConnectionManager httpClientConnectionManager) {
        this(endpoint, timeoutMs, RetryDefaults.DEFAULT_MAX_RETRIES, httpClientConnectionManager, RetryDefaults.DEFAULT_NON_RETRYABLE_EXCEPTIONS);
    }
